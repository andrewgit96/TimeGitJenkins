...
public class Time
{
	...
	public static int getTotalSeconds2(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
		...
		return (int) (hours * 3600 + minutes * 60 + seconds); //I could convert this to float and change return to float type but I want a whole number
	}
	
	// Commented out for ICE6
	public static int getTotalSeconds(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
		...
		return (int) (hours * 3600 + minutes * 60 + seconds + 0.001 * milliseconds); //I could convert this to float and change return to float type but I want a whole number
	}
	...
	//refactored method. Also checked for length of string
